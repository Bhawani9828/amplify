                ...
                <div className="order-2 flex flex-col md:order-1">
                  ...
                  <div className="text-lg leading-[1.4] lg:text-[21px]">
                    <p className="mb-7 last:mb-0">
                      We are here to help you! Tell us how we can help &amp;
                      well be in touch with an expert within the next 24 hours.
                    </p>
                    <ul className="mt-12 flex flex-col gap-y-8 lg:gap-y-12">
                      <li className="flex flex-col gap-y-4 text-2xl font-bold">
                        ...
                        <a
                          ...
                          className="text-2xl font-normal leading-loose hover:text-[#6E3897] lg:text-3xl"
                        >
                          info@mthemeus.com
                        </a>
                      </li>
                        ...
                        <ul className="mt-auto flex gap-x-[15px]">
                          <li>
                            <a
                              ...
                              className="group relative flex h-[30px] w-[30px] items-center justify-center rounded-[50%] bg-black hover:bg-[#6E3897]"
                            >
                              <img
                                src={facebook1}
                                alt="facebook"
                    ...
                    <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
                      ...
                      <div className="flex flex-col gap-y-[10px]">
                        ...
                        <input
                          ...
                          className="rounded-[10px] border border-gray-300 bg-white px-6 py-[18px] font-bold text-black outline-none transition-all placeholder:text-slate-500 focus:border-[#6E3897]"
                          required
                        />
                      </div>
                      {/* Form Single Input */}
                    ...
                    <div className="grid grid-cols-1 gap-6">
                      ...
                      <div className="flex flex-col gap-y-[10px]">
                        ...
                        <textarea
                          ...
                          id="contact-message"
                          className="min-h-[180px] rounded-[10px] border border-gray-300 bg-white px-6 py-[18px] font-bold text-black outline-none transition-all placeholder:text-slate-500 focus:border-[#6E3897]"
