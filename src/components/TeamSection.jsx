            ...
            >
              ...
              <div className="mt-5">
                <a
                  ...
                  className="font-dmSans text-[26px] leading-[1.33] hover:text-[#B840C7] xxl:text-[30px]"
                >
                  {member.name}
                </a>
                      ...
                      ([platform, icons], idx) => (
                        <li key={idx}>
                          <a
                            ...
                            className="group relative flex h-[30px] w-[30px] items-center justify-center rounded-[50%] bg-black hover:bg-[#B840C7]"
                          >
                            <img
                              src={icons[0]}
                              alt={platform}
